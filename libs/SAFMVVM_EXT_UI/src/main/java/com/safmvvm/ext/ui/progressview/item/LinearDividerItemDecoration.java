    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (builder.orientation == LinearLayoutManager.VERTICAL) {
                left = child.getLeft() - params.leftMargin + transitionX + AutoSizeUtils.mm2px(parent.getContext(), builder.leftMargin);
                top = child.getBottom() + params.bottomMargin;
                right = child.getRight() + params.rightMargin - AutoSizeUtils.mm2px(parent.getContext(), builder.rightMargin);
                bottom = top + builder.dividerHeight + transitionY;
            } else {
                top = child.getTop() - params.topMargin + AutoSizeUtils.mm2px(parent.getContext(), builder.topMargin);
                bottom = child.getBottom() + params.bottomMargin + transitionY - AutoSizeUtils.mm2px(parent.getContext(), builder.bottomMargin);
