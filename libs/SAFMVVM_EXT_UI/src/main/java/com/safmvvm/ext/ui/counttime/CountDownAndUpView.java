package com.safmvvm.ext.ui.counttime;
...
public class CountDownAndUpView extends View {
    ...
    public CountDownAndUpView(Context context) {
        this(context, null);
    }

    public CountDownAndUpView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownAndUpView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                // callback
    ...
    public interface OnCountdownEndListener {
        void onEnd(CountDownAndUpView cv);
    }

    public interface OnCountdownIntervalListener {
        void onInterval(CountDownAndUpView cv, long remainTime);
    }
