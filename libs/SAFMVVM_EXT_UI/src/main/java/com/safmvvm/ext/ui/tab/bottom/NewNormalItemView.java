package com.safmvvm.ext.ui.tab.bottom;
...
public class NewNormalItemView extends BaseTabItem {
    ...
    public NewNormalItemView(Context context) {
        this(context, null);
    }

    public NewNormalItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewNormalItemView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CharSequence getAccessibilityClassName() {
        return NewNormalItemView.class.getName();
    }
    ...
    public void setIconSize(int width, int height){
        ...
        layoutParams.width = AutoSizeUtils.mm2px(getContext(), width);
        layoutParams.height = AutoSizeUtils.mm2px(getContext(), height);
        mIcon.setLayoutParams(layoutParams);
    }

    public void setTitleSize(int titleSize){
        mTitle.setTextSize(TypedValue.COMPLEX_UNIT_MM, titleSize);
    }
}
