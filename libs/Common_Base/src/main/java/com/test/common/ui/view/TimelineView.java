package com.test.common.ui.view;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, AutoSizeUtils.mm2px(getContext(), 20));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, AutoSizeUtils.mm2px(getContext(), 2));
        ...
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, AutoSizeUtils.mm2px(getContext(), 8));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, AutoSizeUtils.mm2px(getContext(), 4));
        typedArray.recycle();
